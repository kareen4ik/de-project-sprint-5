...
class OrdersLoader:
    ...
    def run_copy(self) -> int:
        ...
        with self.pg_dest.connection() as conn:
            ...
            load_queue = self.collection_loader.get_orders(None, self._SESSION_LIMIT)
            ...
            #wf_setting.workflow_settings[self.LAST_LOADED_TS_KEY] = max([t["update_ts"] for t in load_queue if "update_ts" in t])
